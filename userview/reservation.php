...
<div class="row ml-5">
  ...
  <div class="d-flex justify-content: center; align-items: center " style="flex-direction: column;">
    <h3 class="ml-5 mt-5">Reservation Check Out List</h3>
    <small class="ml-5" style="color: red">Note: To confirm your reservation, we require a downpayment of 50% of the total balance of your reservation. The remaining balance is due upon arrival and can be paid using the same payment methods or cash. Gcash Account Number of Villa Sampaguita Resort: 09564194660 Send us the proof of payment to process your reservation</small>
  </div>
    ...
    <tbody>
        ...
        <tr>
            ...
            <!-- <td>
              <?php 
                  echo $price = $rows['cottagePrice'];
              ?>
            </td>
            <td>
              <?php 
                  echo $price = $rows['hallPrice'];
              ?>
            </td> -->
            ...
            <td class="d-flex justify-content-center align-items-center" style="flex-direction: column;">
                ...
                <!-- <button type="button" class="btn btn-dark"   data-toggle="modal" data-target="#view"> <i class="fa-solid fa-money"></i> CHECK OUT</button> -->
            </td>
        </tr>
