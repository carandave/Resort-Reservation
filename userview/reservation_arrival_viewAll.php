...
<div class="row ml-5 mb-5">
  ...
  <div class="d-flex justify-content: center; align-items: center ">
    <h3 class="ml-5 mt-5">Confirmed Arrival Information </h3>
  </div>
...
<?php if($result->num_rows > 0){?>
  ...
  <div class="row" style="margin: 0 auto; width: 90%; ">
    ...
    <div class="col-md-5 ml-5 p-5" style="min-height: 400px; color: white; background: #4b7565">
        ...
        <div class="row">
            <div class="col-md-6">
                <span style="font-size: 14px;">Type of Room </span>
            </div>
        ...
        <div class="row">
            <div class="col-md-6 ">
                <span style="font-size: 14px;">Event Hall </span>
            </div>
        ...
        <div class="row">
            <div class="col-md-6 text-center">
                <span style="font-size: 14px;">Event Hall Discount </span>
            </div>
        ...
        <div class="row">
            <div class="col-md-6 text-center">
                <span style="font-size: 14px;"> Downpayment </span>
            </div>
