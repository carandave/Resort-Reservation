...
<div class="row ml-5">
  ...
  <div class="d-flex justify-content: center; align-items: center mb-3" style="flex-direction: column;">
    <h3 class="ml-5 mt-5">Reservation Confirmed List</h3>
    <small class="ml-5" style="color: red">Note: Make sure you are in Villa Sampaguita Resort before you send your full payment for better transaction Thank you!</small>
  </div>
