...
<div class="row ml-5 mb-5">
  ...
  <div class="d-flex justify-content: center; align-items: center ">
    <h3 class="ml-5 mt-5">Reservation Pending List View All Information </h3>
  </div>
  ...
  <div class="row" style="margin: 0 auto; width: 90%; ">
    ...
    <a href="../user_dashboard/" style="margin-left:98%; color: #fff; font-size:small; " class="fa-solid fa-x"></a>
        ...
        <div class="row">
            ...
            <div class="col-md-6 ">
                <span style="font-size: 15px;" class="font-weight-bold"><?php echo $rows['Category'];?> (Php <?php echo $rows['Price'];?>)</span>
