...
<div class="row ml-5">
  ...
  <div class="d-flex justify-content: center; align-items: center ">
    <h3 class="ml-5 mt-5">Cancelled Reservation List</h3>
  </div>
    ...
    <tbody>
        ...
        <tr>
            ...
            <!-- <td>
                <a href="reservation_pending_viewAll.php?resId=<?php echo $rows['reservation_Id'];?>&pepId=<?php echo $rows['people_Id'];?>" class="btn btn-dark">View</a>
