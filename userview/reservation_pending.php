...
<div class="row ml-5">
  ...
  <div class="d-flex justify-content: center; align-items: center ">
    <h3 class="ml-5 mt-5">Reservation Pending List</h3>
  </div>
