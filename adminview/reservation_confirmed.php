...
<div class="row ml-5">
  ...
  <div class="d-flex justify-content: center; align-items: center ">
    <h3 class="ml-5 mt-1">Reservation Confirmed List</h3>
  </div>
  <table class="table table-responsive" id="" style="margin: 0 auto; width: 90%; ">
        ...
        <tbody>
            ...
            $sql = "SELECT r.reservation_Id, r.people_Id, r.name, r.email, r.number, r.room_Id, r.timeInOut, r.dateIn, r.dateOut, r.adult, r.children, r.reservationStatus, r.payment_status, r.dateCreated, r.code, p.people_Id, p.address, t.Category, t.Price, t.Discount, c.title, c.Price as cottagePrice, c.Discount as cottageDiscount, h.title as hallTitle, h.Price as hallPrice, h.Discount as hallDiscount, a.payment_Id, a.people_Id, a.reservation_Id, a.total, a.balance FROM reservation r INNER JOIN people p ON r.people_Id = p.people_Id INNER JOIN room t ON r.room_Id = t.room_Id LEFT JOIN cottage c ON r.cottage_Id = c.cottage_Id LEFT JOIN hall h ON r.hall_Id = h.hall_Id INNER JOIN payment a ON r.reservation_Id = a.reservation_Id WHERE reservationStatus='Confirmed' ORDER BY r.reservation_Id DESC";
            ...
            <tr>
                ...
                <td>
                    <a style="width: 100%;" href="reservation_confirmed_viewAll.php?resId=<?php echo $rows['reservation_Id'];?>&pepId=<?php echo $rows['people_Id'];?>" class="btn btn-dark">View</a>
                    <!-- Button trigger modal -->

                    <!-- Button trigger modal -->
                <button type="button" class="btn btn-info editBtn mt-1" >
                Edit Status
                </button>
                ...
                <div class="modal-dialog" role="document">
                    ...
                    <div class="modal-body">
                        <form action="reservation_confirmed_update.php" method="POST">
                            <div class="row">
                                <div class="col-md-6">
                            ...
                            <div class="row mt-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" value="" id="total" name="total" class="form-control" readonly >
                                </div>
                                <div class="col-md-6">
                                    <label for="">Balance</label>
                                    <input type="text" value="" id="balance" name="balance" class="form-control" readonly >
                                </div>
                            </div>
                            ...
                            <div class="row mt-3">
                                <div class="col-md-12">
                                    ...
                                    <input type="number" value="" id="payment" name="payment" class="form-control" required>
                                </div>
                            </div>
                            ...
                            <div class="row mt-3">
                                <div class="col-md-12">
                                    ...
                                    <input type="number" value="" id="referenceNumber" name="referenceNumber" class="form-control" required>
                                </div>
                            </div>
                            ...
                            <div class="modal-footer">
                                ...
                                <input type="submit" name="payBtn" value="Save" class="btn btn-info">
...
$(document).ready(function (){
    ...
    $('.editBtn').on('click', function(){
                ...
                $('#check_in').val(data[10]);
                $('#check_out').val(data[11]);
                

                $('#total').val(data[14]);
                $('#balance').val(data[15]);

                $("#status option:selected").text(data[17]);
                $("#status option:selected").val(data[17]);
