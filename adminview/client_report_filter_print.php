...
if(isset($_GET['from_date_filter']) && isset($_GET['to_date_filter'])){
    $from_date_filter = $_GET['from_date_filter'];
    $to_date_filter = $_GET['to_date_filter'];
}
...
<div class="row ml-5">
  ...
  <div class="d-flex justify-content: center; align-items: center ">
    <h3 class="ml-5 mt-5">Print Client Reports</h3>
  </div>
  ...
  <div class="card-body m-5" id="printThis">
                    ...
                    <table class="table table-responsive table-sm" id="" style="margin: 0 auto; width: 90%; ">
        ...
        <tbody>
            ...
            $sql = "SELECT * FROM people WHERE user_date_created BETWEEN '$from_date_filter' AND '$to_date_filter' ORDER BY people_Id DESC ";
