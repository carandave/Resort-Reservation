...
<div class="row ml-5">
  ...
  <div class="card-body m-5" id="printThis">
    ...
    <tbody>
        ...
        $sql = "SELECT r.reservation_Id, r.people_Id, r.name, r.email, r.number, r.room_Id, r.dateIn, r.dateOut, r.adult, r.children, r.reservationStatus, r.dateCreated, r.code, t.Category, t.Price FROM reservation r INNER JOIN room t ON r.room_Id = t.room_Id WHERE r.dateCreated BETWEEN '$from_date' AND '$to_date' ORDER BY reservation_Id DESC";
