...
<div class="row mt-3 p-5">
  ...
  <div class="">
        ...
        $sql = "SELECT r.reservation_Id, r.people_Id, r.name, r.email, r.number, r.room_Id, r.dateIn, r.dateOut, r.adult, r.children, r.reservationStatus, r.dateCreated, p.people_Id, t.Category FROM reservation r INNER JOIN people p ON r.people_Id = p.people_Id INNER JOIN room t ON r.room_Id = t.room_Id ";
        $result = $conn->query($sql);
        
        ?><div class="p-3" style="background: #fff;">
           <a href="../admin_dashboard/" style="margin-left:98%; color: #000; font-size:medium; " class="fa-solid fa-square-xmark"></a>
    ...
    <tbody style="width: 100%;">
        ...
        <tr>
            ...
            <td>
                ...
                <span>Total Event Hall Price</span>
            ...
            <td>
                ...
                <div class="modal-dialog" role="document">
                    ...
                    <div class="modal-body">
                        ...
                        <span class="mb-3" style="font-size: 10px; color: red;">Note: The DOWNPAYMENT must be true because we can see and change the data/information you've been maid. We will cancel your reservation request if necessarry Thankyou!.</span>
                        ...
                        <div>
                            <form action="reservation_Admin_checkOutAdd.php" method="POST" enctype="multipart/form-data">
