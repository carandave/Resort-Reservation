          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                            ...
                            <div class="modal-footer">
                                ...
                                <input type="submit" name="save" value="Add Hall" class="btn btn-info">
...
<div class="row ml-5">
  ...
  <div class="d-flex justify-content: center; align-items: center " style="flex-direction: column;">
    <h3 class="ml-5 mt-1">Hall List</h3>
  </div>

  <!-- Button trigger modal -->
  <button type="button" class="btn btn-primary ml-5 mb-3" data-toggle="modal" data-target="#ADD"><i class="fa-solid fa-plus" ></i> Add Hall</button>
    ...
    <tbody>
      <?php
        $query=mysqli_query($conn,"select * from hall");
        ...
        ?>
          ...
          <tr>
              ...
              <td class="d-none"><?php echo $row['hall_Id']; ?></td>
              ...
              <td>
              <button type="button" class="btn btn-info editBtn" data-toggle="modal" data-target="#edit<?php echo $row['hall_Id'];?>"> EDIT</button>
              <!-- <button type="button" class="btn btn-dark"   data-toggle="modal" data-target="#view"> <i class="fa-solid fa-eye"></i> VIEW</button> -->
              </td>


              <!-- Modal -->
              <div class="modal fade" id="edit<?php echo $row['hall_Id'];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        ...
                        <form action="hall_update.php" method="POST" enctype="multipart/form-data">
                          ...
                          <div class="col-md-12">
                            ...
                            <div class="row">
                                ...
                                <input type="text" value="<?php echo $row['hall_Id'];?>" name="hall_Id" id="hall_Id " class="form-control d-none " >
