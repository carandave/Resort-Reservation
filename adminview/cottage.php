...
<body >
        ...
        <!-- Modal -->
      <form method="POST" action="add_cottage.php" enctype="multipart/form-data">
      <div class="modal fade" id="ADD" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">ADD COTTAGE</h5>
...
<div class="row ml-5">
  ...
  <div class="d-flex justify-content: center; align-items: center " style="flex-direction: column;">
    <h3 class="ml-5 mt-1">Cottage List</h3>
  </div>

  <!-- Button trigger modal -->
  <button type="button"  class="btn btn-primary ml-5 mb-3" data-toggle="modal" data-target="#ADD"><i class="fa-solid fa-plus" ></i> Add Cottage</button>
    ...
    <tbody>
      <?php
        $query=mysqli_query($conn,"select * from cottage");
        ...
        ?>
          ...
          <tr>
              ...
              <td class="d-none"><?php echo $row['cottage_Id']; ?></td>
              ...
              <td>
              <button type="button" class="btn btn-info editBtn" data-toggle="modal" data-target="#edit<?php echo $row['cottage_Id'];?>"> EDIT</button>
              <!-- <button type="button" class="btn btn-dark"   data-toggle="modal" data-target="#view"> <i class="fa-solid fa-eye"></i> VIEW</button> -->
              </td>


              <!-- Modal -->
              <div class="modal fade" id="edit<?php echo $row['cottage_Id'];?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    ...
                    <div class="modal-body">
                        <form action="cottage_update.php" method="POST" enctype="multipart/form-data">
                          ...
                          <div class="col-md-12">
                            ...
                            <div class="row">
                                ...
                                <input type="text" value="<?php echo $row['cottage_Id'];?>" name="cottage_Id" id="cottage_Id " class="form-control d-none " >
                            ...
                            <div class="row mt-3">
                                <div class="col-md-12">
                                    <label for="">Description</label>
                                    <textarea name="description" value="<?php echo $row['Description'];?>" id="description" cols="10" rows="5" class="form-control">
                            ...
                            <div class="row mt-3">
                                <div class="col-md-12">
                                    <label for="">Amenities</label>
                                    <textarea name="amenities" value="<?php echo $row['Amenities'];?>" id="amenities" cols="10" rows="5" class="form-control">
