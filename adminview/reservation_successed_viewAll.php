...
<?php if($result->num_rows > 0){?>
    ...
    <h3 class="ml-5 mt-5"><?php echo $rows['name'];?>'s Reservation History Information </h3>
  </div>
  <div class="row" style="margin: 0 auto; width: 90%; ">
    ...
    <a href="../admin_dashboard/" style="margin-left:98%; color: #000; font-size:medium; " class="fa-solid fa-square-xmark"></a>
        ...
        <div class="row">
            <div class="col-md-6 text-center">
                <span style="font-size: 14px;">His/Her Downpayment </span>
            </div>
